 ...
 const [userId,setUserId] = useState(null)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-sky-100 to-indigo-100 px-4 font-inter">
      {
        loggedIn && storedLogin === true ? <Navbar  setLogin = {setLogin} searchTerm={searchTerm} setSearchTerm={setSearchTerm} />:""
      }

      <Routes>
        <Route path="/" element={<Login setUserId={setUserId}  setLogin = {setLogin} setLoggedIn={setLoggedIn} />} />
        <Route path="/home" element={<UserHomePage  searchTerm={searchTerm} />} />
